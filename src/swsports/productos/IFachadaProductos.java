...
public interface IFachadaProductos {
      ...
      */
       ...
       * @param carrito Carrito de donde se va a añadir el producto.
       ...
       * @param carrito Carrito de donde se va a eliminar el producto
      ...
      /**
       * Encarga una lista de productos contenida en el carrito.
       * 
       * @param carrito Carrito de donde se va a realizar la compra.
