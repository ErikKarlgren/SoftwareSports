...
public class ControladorProductos {
	...
	/**
	 * Edita los datos de un producto. Su identificador (id) se usará para buscar
	 * el usuario que se quiere editar y se sobrescribirán el resto de datos.
	 *
	...
	/**
	 * Devuelve una lista de los productos que se adhieren a los parámetros de
	 * búsqueda proporcionados. Los parámetros que sean nulos en el objeto
	 * {@link TransferProducto} no se usarán para la búsqueda.
	 *
	 * @param tProd Objeto {@link TransferProducto} usado como parametro de
	 *              búsqueda
	 ...
	 * @param carrito Carrito en el que se a�ade el producto
	 ...
	 * 	 * @param carrito Carrito del que se quiere quitar un producto
	...
	/**
	 * Compra lo que est� en un carrito.
	 * 
	 * @param carrito Carrito del que se compra
