 ...
 * principales de cada m�dulo.
 * 
 * Las subclases deben de asegurarse de que los componentes que se quieran
 * a�adir a la GUI se inicien en el m�todo {@link #getComponentesBusqueda()} y
 * que {@link #getNewSwingWorker()} devuelva un nuevo objeto que sea subclase de
 * {@link BuscarSwingWorker} (se recomienda que la implementaci�n sea una clase
 * interna por claridad del c�digo).
 * 
...
public abstract class AbstractPanelMain<T extends Reportable> extends JPanel {
	...
	/**
	 * Implementaci�n de {@link SwingWorker} que busca usuarios seg�n unos criterios
	 * de b�squeda y crea paneles con sus datos. Durante la ejecuci�n de
	...
	protected abstract class BuscarSwingWorker extends SwingWorker<Void, DataPanel<T>> {
		 ...
		 * m�todo, leer los datos de los componentes guardados en
	...
	/**
	 * Panel donde aparecer�n los datos de los objetos de tipo {@link Reportable}
	...
	private class DefaultPanelPrincipal extends JScrollPane {
		...
		/**
		 * Crea la interfaz gr�fica del panel.
		 */
	...
	/**
	 * Subpanel izquierdo en el que se introducen los par�metros de b�squeda. Los
	 * campos que se dejen vac�os deber�an ignorarse en las subclases de
	...
	private class PanelBusqueda extends JScrollPane {
		...
		/**
		 * A�ade una serie de componentes {@link JComponent} guardados en un mapa
		 * {@link LinkedHashMap} intercalados con objetos {@link JLabel} creados a
		 * partir de las claves de dicho mapa. A�ade finalmente el bot�n de b�squeda.
		 * 
		 * @param comps Mapa con los componentes y su {@link String} correspondiente con
		 *              el que se crear�n sus respectivos {@link JLabel}.
		 */
		...
		/**
		 * A�ade una separaci�n vertical de un n�mero determinado de p�xeles.
		 * 
		 * @param x N�mero de p�xeles de separaci�n.
		 */
		 ...
		 * 
		 * @param name Par�metro para construir el {@link JLabel}.
	...
	/**
	 * Crea un campo de texto de un tama�o m�ximo determinado
	 * ({@value #TXT_FIELD_HEIGHT} p�xeles de alto, y {@value #TXT_FIELD_WIDTH}
	 * p�xeles de largo).
	 * 
	 * @return Un {@link JTextField} con cierto tama�o m�ximo.
	 */
	 ...
	 * principio se usar� para el panel principal.
	 * 
	...
	/**
	 * M�todo donde se deben iniciar los componentes que se vayan a a�adir al
	 * subpanel {@link PanelBusqueda} de {@link AbstractPanelMain}. Devuelve un mapa
	 * {@link LinkedHashMap} con pares de {@link String} que se usar�n para crear
	...
	/**
	 * M�todo que debe ser implementado y tiene que devolver la implementaci�n de
	 ...
	 * t�tulo de dicho subpanel.
	 * 
	 * @param nombreModulo En principio el t�tulo de del subpanel, aunque se puede
	 *                     omitir si se quiere al sobrescribir este m�todo.
	 * @return Devuelve un {@link JScrollPane} que servir� como panel principal.
	 */
	...
	/**
	 * Quita los paneles {@link DataPanel} del PanelPrincipal. Se usa para no a�adir
	...
	/**
	 * Habilita o deshabilita el bot�n de b�squeda.
	 * 
